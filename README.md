...
*If you've never used GitHub before, click on readme.md and then the edit (pencil icon) to contribute to this document. It will then create a "pull request" for me to merge. The code for the document is simple [Markdown] (https://guides.github.com/features/mastering-markdown/) that's easy to learn*
...
-  If you rarely need medical care and have a high-deductible plan available to you with the ability to contribute to an HSA then you should consider it if you can plan to max out HSA contributions each year until the balance is above your out of pocket maximum and then you can tone down contributions if you choose to increase savings elsewhere.
-    HSAs stay with you for life to help pay for a wide range of medical expenses and the funds can be accessed for any use after 60. They are great pre-tax saving vehicles to pay for medical expenses.
-    If you don't have access to a HSA I recommend sticking with a good comprehensive health plan and wouldn't get a high deductible plan without it.
